            ...
            <div style={{className: 'App', display: 'flex', alignItems: 'right', textAlign: 'left', margin: '20px 0', backgroundColor: 'black'}}>
                <div style={{textAlign: 'left'}}>
                    ...
                    <p className='p_text'>
                        ...
                        to run until the end of the railway. Freight traffic caused revenue problems, and a move by CN's Terra Transport division to containerization proved to only be a temporary 
