    ...
    return (
        ...
        <div style={{className: 'App', display: 'flex', alignItems: 'flex-start', textAlign: 'left', margin: '20px 0', backgroundColor: 'black'}}>
          ...
          with the park.
                    ...
                    <img src={`${process.env.PUBLIC_URL}/images/trinity_loop_1.jpg`} alt="the Trinity Loop in the 70's." style={{ width: '35%', height: '35%' }} className="img-zoom" />
                    <img src={`${process.env.PUBLIC_URL}/images/trinity_loop_2.jpg`} alt="The Trinity Loop today." style={{ width: '40%', height: '40%' }} className="img-zoom" />
                </div>
